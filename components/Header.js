        ...
        <header className="mx-auto flex max-w-screen-xl items-center px-3 py-2.5 2xl:max-w-screen-2xl">
            <Link href={'/'} className="mr-auto">
                <div className="relative">
                    <span className="relative z-10 bg-gradient-to-r from-blue-500 via-blue-600 to-purple-600 bg-clip-text text-3xl font-bold tracking-tight text-transparent">
                        ATS PRO
                    </span>
